define('echarts/chart/map', [
    ...
    var mapParams = {
        ...
        '国网': {
            getGeoJson: function (callback) {
                require(['./geoJson/extended/china_geo'], function (md) {
                    callback(decode(md));
                });
            }
        },
        'area': {
            getGeoJson: function (callback) {
                require(['./geoJson/extended/area.geo'], function (md) {
                    callback(decode(md));
                });
            }
        },
        '东北': {
            getGeoJson: function (callback) {
                require(['./geoJson/extended/db.geo'], function (md) {
                    callback(decode(md));
                });
            }
        },
        '华北': {
            getGeoJson: function (callback) {
                require(['./geoJson/extended/hb.geo'], function (md) {
                    callback(decode(md));
                });
            }
        },
        '华东': {
            getGeoJson: function (callback) {
                require(['./geoJson/extended/hd.geo'], function (md) {
                    callback(decode(md));
                });
            }
        },
        '华南': {
            getGeoJson: function (callback) {
                require(['./geoJson/extended/hn.geo'], function (md) {
                    callback(decode(md));
                });
            }
        },
        '华中': {
            getGeoJson: function (callback) {
                require(['./geoJson/extended/hz.geo'], function (md) {
                    callback(decode(md));
                });
            }
        },
        '西北': {
            getGeoJson: function (callback) {
                require(['./geoJson/extended/xb.geo'], function (md) {
                    callback(decode(md));
                });
            }
        },
        '西南': {
            getGeoJson: function (callback) {
                require(['./geoJson/extended/xn.geo'], function (md) {
                    callback(decode(md));
                });
            }
        },
